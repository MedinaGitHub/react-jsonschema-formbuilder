...
const ButtonGroup = connect(null, (dispatch, { id }) => ({
  select: () =>
    dispatch({ type: "ACTIVE_NODE_KEY_SET_BY_RJSF_ID", payload: id }),
    ...
    (dispatch, { id, schema, uiSchema }) => ({
      ...
      updateDescription: (description) =>
        dispatch({
          ...
          payload: {
            rjsfId: id,
            nodeUpdate: { schema: { ...schema, description } },
          },
        }),
      updateHelp: (help) =>
        dispatch({
          ...
          payload: {
            rjsfId: id,
            nodeUpdate: { uiSchema: { ...uiSchema, "ui:help": help } },
          },
        }),
    })
  )((props) => {
    ...
    (dispatch, { idSchema, schema }) => ({
      updateTitle: (title) =>
        dispatch({
          ...
          payload: {
            rjsfId: idSchema.$id,
            nodeUpdate: { schema: { ...schema, title } },
          },
        }),
      updateDescription: (description) =>
        dispatch({
